...
void Sandbox2D::OnUpdate(Cheese::Timestep ts)
{
...

	{
		...
		Cheese::Renderer2D::DrawRotatedQuad({ -1.0f, 0.0f }, { 0.8f, 0.8f }, glm::radians(-45.0f), { 0.8f, 0.2f, 0.3f, 1.0f });
		Cheese::Renderer2D::DrawQuad({ 0.5f, -0.5f }, { 2.0f, 2.0f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Cheese::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_CheckerboardTexture, 10.0f);
