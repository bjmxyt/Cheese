...
{
	m_VertexArray = Cheese::VertexArray::Create();
	...
	Cheese::Ref<Cheese::VertexBuffer> vertexBuffer = Cheese::VertexBuffer::Create(vertices, sizeof(vertices));
	...
	Cheese::Ref<Cheese::IndexBuffer> indexBuffer = Cheese::IndexBuffer::Create(indices, sizeof(indices) / sizeof(uint32_t));
	m_VertexArray->SetIndexBuffer(indexBuffer);

	m_SquareVA = Cheese::VertexArray::Create();
	...
	Cheese::Ref<Cheese::VertexBuffer> squareVB = Cheese::VertexBuffer::Create(squareVertices, sizeof(squareVertices));
	squareVB->SetLayout({
		{ Cheese::ShaderDataType::Float3, "a_Position" },
	...
	Cheese::Ref<Cheese::IndexBuffer> squareIB = Cheese::IndexBuffer::Create(squareIndices, sizeof(squareIndices) / sizeof(uint32_t));
...
void ExampleLayer::OnUpdate(Cheese::Timestep ts)
{
	// Update
...
void ExampleLayer::OnEvent(Cheese::Event& e)
{
